...
export default function MobileNotice({ hasOpenWindows }: { hasOpenWindows: boolean }) {
  ...
  return (
    ...
    >
      <div className="bg-window-bg border-2 border-window-border rounded-xl shadow-flat p-5 flex items-start gap-4">
        ...
        <SoundHover playType="click" src="/assets/original/sounds/click_general.mp3" vol={0.5}>
          <button
            ...
            className="shrink-0 relative inline-block px-4 py-2 font-medium group"
          >
